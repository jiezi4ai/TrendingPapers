# Acknowledgements
# Souce code from opsdisk's library [yagooglesearch](https://github.com/opsdisk/yagooglesearch)
# with slight modification on proxy setup in SearchClient initiation
# Previously:
        # if proxy:
        #     self.proxy_dict = {
        #         "http": self.proxy,
...
# Modification:
        ...
        #     self.proxy_dict = {"http": self.proxy}

        # elif self.proxy.startswith("https://"):
        #     self.proxy_dict = {"http": self.proxy, "https": self.proxy}    

        # elif self.proxy.startswith("socks5://") or self.proxy.startswith("socks4://"):
        #     self.proxy_dict = {"http": self.proxy, "https": self.proxy}     
...
class SearchClient:
    def __init__(
        ...
        proxy=None,  # jiezi4ai: default value change from "" to None
        verify_ssl=True,
        verbosity=5,
        ...
        # jiezi4ai: modification made here
        if self.proxy:
            if self.proxy.startswith("http://"):
                self.proxy_dict = {"http": self.proxy}
